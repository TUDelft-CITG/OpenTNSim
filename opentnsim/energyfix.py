...
class ConsumesEnergy:
    ...
    def calculate_SFC_for_diesel_and_alternatives(self):
    ...
    def calculate_required_amount_of_alternatives(self):
        """ 
        ...
        for i in range(len(times) - 1):
            ...
            if delta_t != 0:
                ...
                if (
                    ...
                    emission_delta_fuel = (
                        self.vessel.total_factor_FU * energy_delta
                    )  # in g
                    ...
                    self.energy_use["total_fuel_consumption"].append(
                        emission_delta_fuel
                    )
                    ...
                    if not np.isnan(h_0):
                        ...
                        self.energy_use["water depth"].append(
                            self.energy_use["water depth"].iloc[i]
                        )
