...
def test_basic_simulation():
    ...
    np.testing.assert_almost_equal(550/4+500/2+(300-0.5*155)/2+(0.5*155+500)/1+(300-0.5*155)/1,
    ...
    np.testing.assert_almost_equal(2*(lock_1.doors_open+lock_1.doors_close+2*lock_1.lock_width*lock_1.lock_length*wlev_dif[1][0]/(lock_1.disch_coeff*lock_1.opening_area*math.sqrt(2*lock_1.grav_acc*lock_1.opening_depth)))+
                                   2*(0.5*155+(500+300-0.5*155))+550/4+0.5*155+800/4+(500+300-0.5*155)/2,
                                   lock_cycle_start[1], decimal=0, err_msg='', verbose=True)

    np.testing.assert_almost_equal(550/4+(500+300-0.5*155)/2+500+300-0.5*155,
    ...
    np.testing.assert_almost_equal(2*(lock_1.doors_open+lock_1.doors_close+2*lock_1.lock_width*lock_1.lock_length*wlev_dif[1][0]/(lock_1.disch_coeff*lock_1.opening_area*math.sqrt(2*lock_1.grav_acc*lock_1.opening_depth)))+
                                   0.5*155+500/4+300/4+((550/4+500/2+(300-0.5*155)/2+(0.5*155+500)/1+(300-0.5*155)/1)-(550/4+(500+300-0.5*155)/2+500+300-0.5*155)),
                                   waiting_in_lineup_duration[1], decimal=0, err_msg='', verbose=True)

    np.testing.assert_almost_equal((300-0.5*155)/2+500/2,
