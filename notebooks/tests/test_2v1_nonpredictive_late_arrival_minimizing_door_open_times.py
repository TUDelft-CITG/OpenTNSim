...
lock = lock_module.IsLockComplex(env=env,
                                 ...
                                 node_A = 'A',
                                 node_B = 'B',
                                 distance_lock_doors_A_to_waiting_area_A = 2300,
                                 distance_lock_doors_B_to_waiting_area_B = 2300,
                                 ...
                                 sailing_in_time_gap_through_doors = 120,
                                 sailing_in_speed = 1.5,
                                 sailing_out_speed = 1.5,
                                 sailing_out_time_gap_through_doors = 60,
                                 time_step = 30,
                                 sailing_time_before_opening_lock_doors = 120,
...
vessel_3 = Vessel(**{"env": env,
                     ...
                     "C_year": 2010,
                     "L_w":3,
                     "arrival_time": pd.Timestamp('2025-01-01 00:07:00')})
...
def test_results():
    ...
    np.testing.assert_almost_equal((vessel_df3.loc[5].Timestamp-vessel_df1.loc[5].Timestamp).total_seconds()/10,
                                   12,decimal=0)
    
    
    np.testing.assert_equal(len(lock_df),20)
    assert 0 == 0
