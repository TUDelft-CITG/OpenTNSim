...
vessel_2 = Vessel(**{"env": env,
                     ...
                     "L_w":3,
                     "C_year": 2010,
                     "arrival_time": pd.Timestamp('2025-01-01 00:35:00')})
...
vessel_3 = Vessel(**{"env": env,
                     ...
                     "C_year": 2010,
                     "L_w":3,
                     "arrival_time": pd.Timestamp('2025-01-01 00:40:00')})
...
vessel_4 = Vessel(**{"env": env,
                     ...
                     "C_year": 2010,
                     "L_w":3,
                     "arrival_time": pd.Timestamp('2025-01-01 00:45:00')})
...
def test_results():
    ...
    np.testing.assert_almost_equal(lock.operation_planning.iloc[2].time_departure_start.round('s').to_pydatetime().timestamp()/10,
                                   vessel_df3.loc[11].Timestamp.to_pydatetime().timestamp()/10,decimal=0)
