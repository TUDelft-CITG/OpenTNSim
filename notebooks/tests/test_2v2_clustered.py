...
def test_results():
    ...
    np.testing.assert_almost_equal((lock.vessel_planning.time_lock_entry_start.iloc[3]-lock.vessel_planning.time_lock_entry_start.iloc[1]).total_seconds(),
                                    lock.sailing_in_time_gap_through_doors,decimal=0)
