...
def test_results():
    ...
    assert np.round(vessel_df3.loc[10].Timestamp.to_pydatetime().timestamp()-vessel_df1.loc[8].Timestamp.to_pydatetime().timestamp()) >= lock.sailing_out_time_gap_through_doors
