...
class ConsumesEnergy:
    ...
    def calculate_frictional_resistance(self, v, h_0):
        ...
        self.R_e = v * self.L / self.nu  # Reynolds number (fresh water density here used rho = 1, refer to Zeng's Re number Table 2)
        print('R_e',self.R_e)
    ...
    def calculate_total_power_required(self, v):
        ...
        # return self.P_given, self.P_propulsion
        return self.P_propulsion
