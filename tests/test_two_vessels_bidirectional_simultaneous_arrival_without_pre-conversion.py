...
def test_basic_simulation():
    ...
    data_vessel_two = {
        "env": env,
        "name": "Vessel",
        "route": nx.dijkstra_path(graph, end_point, start_point, weight="length"),
        "geometry": graph.nodes[end_point]["geometry"],
        "capacity": 1_000,
        "v": 4,
        "type": "CEMT - Va",
        "B": 10,
    ...
    np.testing.assert_almost_equal(
        550 / 4 + 500 / 2 + (300 - 0.5 * 135) / 2, waiting_in_lineup_start[1], decimal=0, err_msg="", verbose=True
    )
