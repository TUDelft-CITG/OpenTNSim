...
def test_simulation(expected_df):
    ...
    for index, value in enumerate(input_data['V_s']):
        ...
        plot_data[label + ' total_diesel_consumption_C_year_ICE_mass']   = list(df.total_diesel_consumption_C_year_ICE_mass[[0, 0, 1, 1, 2, 2, 3, 3]])  

        plot_data[label + ' total_diesel_consumption_ICE_mass']   = list(df.total_diesel_consumption_ICE_mass[[0, 0, 1, 1, 2, 2, 3, 3]])  
