...
def test_simulation():
    ...
    np.testing.assert_almost_equal(6.0476, plot_data['V_s = 3.0 P_tot_given = None fuel_kg_per_km'][1], decimal=2, err_msg='not almost equal', verbose=True)
    np.testing.assert_almost_equal(6.9058, plot_data['V_s = 3.5 P_tot_given = None fuel_kg_per_km'][1], decimal=2, err_msg='not almost equal', verbose=True)
    np.testing.assert_almost_equal(8.4331, plot_data['V_s = 4.0 P_tot_given = None fuel_kg_per_km'][1], decimal=2, err_msg='not almost equal', verbose=True)    
    np.testing.assert_almost_equal(19187.4841, plot_data['V_s = 3.0 P_tot_given = None CO2_g_per_km'][1], decimal=2, err_msg='not almost equal', verbose=True)
    np.testing.assert_almost_equal(21910.2471, plot_data['V_s = 3.5 P_tot_given = None CO2_g_per_km'][1], decimal=2, err_msg='not almost equal', verbose=True)
    np.testing.assert_almost_equal(26756.0599, plot_data['V_s = 4.0 P_tot_given = None CO2_g_per_km'][1], decimal=2, err_msg='not almost equal', verbose=True)
    np.testing.assert_almost_equal(12.6453, plot_data['V_s = 3.0 P_tot_given = None PM10_g_per_km'][1], decimal=2, err_msg='not almost equal', verbose=True)
    np.testing.assert_almost_equal(13.0761, plot_data['V_s = 3.5 P_tot_given = None PM10_g_per_km'][1], decimal=2, err_msg='not almost equal', verbose=True)
    np.testing.assert_almost_equal(15.0179, plot_data['V_s = 4.0 P_tot_given = None PM10_g_per_km'][1], decimal=2, err_msg='not almost equal', verbose=True)
    np.testing.assert_almost_equal(279.7086, plot_data['V_s = 3.0 P_tot_given = None NOx_g_per_km'][1], decimal=2, err_msg='not almost equal', verbose=True)
    np.testing.assert_almost_equal(304.1339, plot_data['V_s = 3.5 P_tot_given = None NOx_g_per_km'][1], decimal=2, err_msg='not almost equal', verbose=True)
    np.testing.assert_almost_equal(362.8966, plot_data['V_s = 4.0 P_tot_given = None NOx_g_per_km'][1], decimal=2, err_msg='not almost equal', verbose=True)
    np.testing.assert_almost_equal(6.0476, plot_data['V_s = None P_tot_given = 251 fuel_kg_per_km'][1], decimal=2, err_msg='not almost equal', verbose=True)
    np.testing.assert_almost_equal(6.9058, plot_data['V_s = None P_tot_given = 343 fuel_kg_per_km'][1], decimal=2, err_msg='not almost equal', verbose=True)
    np.testing.assert_almost_equal(8.4331, plot_data['V_s = None P_tot_given = 494 fuel_kg_per_km'][1], decimal=2, err_msg='not almost equal', verbose=True)    
    np.testing.assert_almost_equal(19187.4841, plot_data['V_s = None P_tot_given = 251 CO2_g_per_km'][1], decimal=2, err_msg='not almost equal', verbose=True)
    np.testing.assert_almost_equal(21910.2471, plot_data['V_s = None P_tot_given = 343 CO2_g_per_km'][1], decimal=2, err_msg='not almost equal', verbose=True)
    np.testing.assert_almost_equal(26756.0599, plot_data['V_s = None P_tot_given = 494 CO2_g_per_km'][1], decimal=2, err_msg='not almost equal', verbose=True)
    np.testing.assert_almost_equal(12.6453, plot_data['V_s = None P_tot_given = 251 PM10_g_per_km'][1], decimal=2, err_msg='not almost equal', verbose=True)
    np.testing.assert_almost_equal(13.0761, plot_data['V_s = None P_tot_given = 343 PM10_g_per_km'][1], decimal=2, err_msg='not almost equal', verbose=True)
    np.testing.assert_almost_equal(15.0179, plot_data['V_s = None P_tot_given = 494 PM10_g_per_km'][1], decimal=2, err_msg='not almost equal', verbose=True)
    np.testing.assert_almost_equal(279.7086, plot_data['V_s = None P_tot_given = 251 NOx_g_per_km'][1], decimal=2, err_msg='not almost equal', verbose=True)
    np.testing.assert_almost_equal(304.1339, plot_data['V_s = None P_tot_given = 343 NOx_g_per_km'][1], decimal=2, err_msg='not almost equal', verbose=True)
    np.testing.assert_almost_equal(362.8966, plot_data['V_s = None P_tot_given = 494 NOx_g_per_km'][1], decimal=2, err_msg='not almost equal', verbose=True)   
