...
def calculate_actual_T_and_payload(self, h_min, ukc=.3,vesl_type="Dry_DH"):
    ...
    # Test if the output of "Dry_DH" vessel are the same as Table 7 showing in(Van Dosser  et al.)
        np.testing.assert_almost_equal(calculate_actual_T_and_payload(self, h_min=1.7, ukc=.3,vesl_type="Dry_DH"),
                                  (1.4,469) , decimal=0, err_msg='', verbose=True)
