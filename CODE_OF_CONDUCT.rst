...
We want `OpenTNSim` to be an open, welcoming, diverse, inclusive, and healthy community. We do not
tolerate rude or disrespectful behaviour toward anyone. For most people, this should be enough
information to just know what we mean. However, for more specific expectations, see our code of
conduct below.
